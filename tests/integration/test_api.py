...
from domain.value_objects import Money, Currency, TicketQuantity, AttendeeInfo
...
class TestIntegration:
    ...
    def test_cancel_nonexistent_order(self, client):
        ...
        resp = client.delete("/api/v1/orders/00000000-0000-0000-0000-000000000000", json={
            "reason": "Test"
        })
        assert resp.status_code == 404
...
class TestDatabaseOperations:
    ...
    def test_database_tables_exist(self, database_url):
        ...
        expected_tables = {"plans", "orders", "payments", "attendees", "seats", "outbox", "alembic_version"}
